...
| Sharded cluster support | ❌ (Enterprise Operator only) | ✅ |
| Integrated backup (PBM) | ❌ (external tooling required) | ✅ (built-in PBM integration) |
| Point-in-time recovery | ❌ | ✅ (oplog-based via PBM) |
| TLS management | Basic | Full (auto-rotation support) |
| Encryption at rest | ❌ | ✅ (KMIP / key file) |
| Multi-cluster support | ❌ | ✅ |
| Automated minor upgrades | ✅ | ✅ |
| PMM integration | ❌ | ✅ (Percona Monitoring and Management) |
| Helm chart | ✅ | ✅ |
