...
- Detailed architecture documentation with Mermaid diagrams covering all platform layers (self-service, operator, data, backup, observability, CDC, security, multi-tenancy, CI/CD)

## v1.0.3 - 2026-03-11

### Fixed

- Align release workflow wait logic with test workflow (3-pod existence check + PSMDB ready state)
- Pin Helm chart versions and kind node image in release workflow for reproducible builds
